...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/linshiqing/MyLibrary'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'linshiqing' => 'linshiqing001@ke.com' }
  s.source           = { :git => 'https://github.com/linshiqing/MyLibrary.git', :tag => s.version.to_s }
